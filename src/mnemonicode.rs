...
// `static` (not `const`) so the 1633-element table exists once in the binary
// rather than being duplicated at each use site (clippy::large_const_arrays).
pub static WORD_LIST: [&str; 1633] = [
