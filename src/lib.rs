...
///
/// Short form for values below 128 (0x80), otherwise long form with minimum trailing bytes.
...
///
/// Advances past the tag and length, leaving the cursor at the first content byte.
