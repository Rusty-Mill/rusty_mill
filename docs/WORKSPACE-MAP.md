...
An interactive, searchable snapshot of this table lives at [`docs/WORKSPACE-ATLAS.html`](./WORKSPACE-ATLAS.html) — download it and open it in a browser to browse by layer and inspect dependents. It is a point-in-time export, not regenerated automatically; re-run the export whenever this file changes meaningfully.
