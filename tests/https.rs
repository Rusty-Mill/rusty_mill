...
fn https_end_to_end() {
    run(async {
        ...
        let url = format!("https://127.0.0.1:{}/hello", server.addr.port());
        ...
        #[cfg(not(target_os = "windows"))]
        {
            ...
            //    self-signed certificate is *not* silently accepted.
        ...
        {
            // On Windows, rustls-native-certs queries the Windows CryptoAPI ROOT store,
            // which does not inspect SSL_CERT_FILE. Verify https_end_to_end with pinned_anchors.
