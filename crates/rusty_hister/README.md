...
| [`rusty-hister-extractor`](crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | Extractor chain-of-responsibility registry — **implemented** (Phase 1); 3 of the 20 built-in per-site/format content extractors done (JSON-LD, EmbeddedVideo, StackExchange), 17 remaining |
