...
| [`rusty-hister-extractor`](crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | Extractor chain-of-responsibility registry — **implemented** (Phase 1); 5 of the 20 built-in per-site/format content extractors done (JSON-LD, EmbeddedVideo, StackExchange, GoDoc, Lobsters), 15 remaining |
