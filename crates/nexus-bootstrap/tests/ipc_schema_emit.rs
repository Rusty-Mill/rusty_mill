...
use nexus_ai::ipc::{
    ...
    AiStreamChatArgs, AiStreamChatMode, AiToolPolicy, AiTurnToolCall, AiUnmappedToolCall,
    EnrichEntityArgs, EnrichEntityResult, EntityRecallArgs, EntityRecallHitRow, EntityRecallResult,
...
use nexus_storage::ipc::{
    ...
    StorageBaseRecordUpdateArgs, StorageBaseViewArgs, StorageCanvasPatchArgs,
    StorageCanvasWriteArgs, StorageChunkEmbedding, StorageConfigContentResult,
    StorageConfigKindArgs, StorageEditArgs, StorageEditConflict, StorageEditFileResult,
...
fn emit_all_schemas_impl() {
    ...
    // ── com.nexus.storage::ast_query (Phase 5.2 / RFC 0005) ──────────────
    write_schema::<StorageAstQueryArgs>("com_nexus_storage__ast_query", "args");
    write_schema::<StorageAstQueryMatch>("com_nexus_storage__ast_query", "match");
    write_schema::<StorageAstQueryResult>("com_nexus_storage__ast_query", "result");
    ...
    write_schema::<StorageNoteCreateUniqueArgs>("com_nexus_storage__note_create_unique", "args");
    write_schema::<StorageNoteCreateUniqueResult>(
        "com_nexus_storage__note_create_unique",
        "result",
    );
