...
//! few more: MD4 and HMAC-MD5 for NTLMv2, SHA-256 for the CredSSP public-key
//! channel binding, and — for Kerberos's AES profiles — AES, HMAC-SHA1, and
//! PBKDF2. To keep the crate dependency-free they are all implemented here by
