...
| [`rusty-hister-extractor`](crates/rusty_hister/crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | rusty_hister: extractor chain-of-responsibility registry, plus four concrete extractors (JSON-LD, EmbeddedVideo, StackExchange, GoDoc; 16 of 20 remaining) |
