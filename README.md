...
| [`rusty-hister-extractor`](crates/rusty_hister/crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | rusty_hister: extractor chain-of-responsibility registry, plus three concrete extractors (JSON-LD, EmbeddedVideo, StackExchange; 17 of 20 remaining) |
