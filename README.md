...
| [`rusty-hister-extractor`](crates/rusty_hister/crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | rusty_hister: extractor chain-of-responsibility registry, plus five concrete extractors (JSON-LD, EmbeddedVideo, StackExchange, GoDoc, Lobsters; 15 of 20 remaining) |
