...
| [`rusty-hister-extractor`](crates/rusty_hister/crates/rusty-hister-extractor) | `crates/rusty_hister/crates/rusty-hister-extractor` | rusty_hister: extractor chain-of-responsibility registry, plus thirteen concrete extractors (JSON-LD, EmbeddedVideo, StackExchange, GoDoc, Lobsters, HackerNews, GitHub, ChatGPT, Basic, Wikipedia, Reddit, Markdown, OrgMode; 7 of 20 remaining) |
